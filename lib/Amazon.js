...
class AmazonScraper {
        ...
        return new Promise(async (resolve, reject) => {
            const options = {
                ...
                headers: {
                    ...
                    'accept-language': 'ja-JP,ja;q=0.9, en-US,en;q=0.1',
    ...
    async startScraper() {
        ...
        if (parseFloat(this.rating[0])<0 || !parseFloat(this.rating[1])) {
    ...
    grabProduct(body, p) {
        ...
        for (let key in scrapingResult) {
            try {
                ...
                //const priceSearch = $(`div[data-asin=${key}] span[class="a-price"]`)[0];
